                    ...
                    <div class="col-xl-7 col-md-7 col-lg-7">
                        <div class="wsus__pro_details_text">
                            ...
                            @if (checkDiscount($product))
                                <h4>
                                    {{$settings->currency_icon}}{{ number_format($product->offer_price, 0) }}
                                    <del>{{$settings->currency_icon}}{{ number_format($product->price, 0) }}</del>
                                </h4>
                            @else
                                <h4>{{$settings->currency_icon}}{{ number_format($product->price, 0) }}</h4>
                            @endif
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-6 col-xxl-7 col-md-6 mt-4 mt-md-0">
                                                <div class="wsus__pro_det_vendor_text">
                                                    ...
                                                    <a href="{{route('vendor.products', $product->vendor->id)}}" class="common_btn">visit store</a>
                                                </div>
                                            </div>
                                            <div class="col-xl-12">
