                                            ...
                                            ',
                                                ...
                                                @foreach ($vendors as $vendor)
                                                    ...
                                                    <button class="nav-link chat-user-profile"
                                                        data-id="{{ $vendor->vendor_id }}" data-bs-toggle="pill"
                                                        data-bs-target="#v-pills-home" type="button" role="tab"
                                                        aria-controls="v-pills-home" aria-selected="true">
                                                        <div
                                                            class="wsus_chat_list_img {{ $unseenMessagesCount > 0 ? 'msg-notification' : '' }}">
                                                            <img src="{{ asset($vendor->vendor_image) }}" alt="vendor"
                                                                class="img-fluid">
                                                            @if ($unseenMessagesCount > 0)
                                                                <span class="pending" id="pending-{{ $vendor->vendor_id }}">
                                                                    {{ $unseenMessagesCount }}
                                                                </span>
                                                            @endif
                                                        </div>
