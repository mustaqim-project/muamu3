                                ...
                                <a class="wsus__hot_deals__single" href="{{ route('product-detail', $item->slug) }}">
                                    ...
                                    <div class="wsus__hot_deals__single_text">
                                        ...
                                        @if (checkDiscount($item))
                                            <p class="wsus__tk">
                                                {{ $settings->currency_icon }}{{ number_format($item->offer_price, 0, ',', '.') }}
                                                <del>{{ $settings->currency_icon }}{{ number_format($item->price, 0, ',', '.') }}</del>
                                            </p>
                                        @else
                                            <p class="wsus__tk">
                                                {{ $settings->currency_icon }}{{ number_format($item->price, 0, ',', '.') }}
                                            </p>
                                        @endif
