                    ...
                    <div class="col-xl-3 col-lg-3">
                        <div class="wsus__payment_menu" id="sticky_sidebar">
                            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist"
                                ...
                                aria-controls="v-pills-bank" aria-selected="false">Transfer BANK</button>
...
{{--
                            ...
                            @include('frontend.pages.payment-gateway.bank')
                    ...
                    <div class="col-xl-4 col-lg-4">
                        <div class="wsus__pay_booking_summary" id="sticky_sidebar2">
                            ...
                            <p>Shipping Fee: <span>{{ $settings->currency_icon }}{{ number_format($biayakirim, 2) }}</span></p>
                            <p>Coupon: <span>{{ $settings->currency_icon }}{{ number_format(getCartDiscount(), 2) }}</span></p>
                            <p>Qty Barang: <span>{{ $totalQty }}</span></p>
                            <h6>Total: <span>{{ $settings->currency_icon }}{{ number_format(getCartTotal() + $biayakirim, 2) }}</span></h6>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4">
                        <div class="wsus__payment_summary">
