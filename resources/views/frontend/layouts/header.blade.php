...
<header>
            ...
            <div class="col-xl-5 col-3 col-md-3 col-lg-6">
                <div class="wsus__call_icon_area">
                    ...
                    <ul class="wsus__icon_area">
                        <li><a href="{{ route('user.wishlist.index') }}"><i class="fal fa-heart" style="color: black;"></i><span id="wishlist_count">
                            @if (auth()->check())
                        ...
                        <li><a class="wsus__cart_icon" href="#"><i
                                    class="fal fa-shopping-bag" style="color: black;"></i><span id="cart-count">{{Cart::content()->count()}}</span></a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="wsus__mini_cart">
            ...
            @foreach (Cart::content() as $sidebarProduct)
                <li id="mini_cart_{{$sidebarProduct->rowId}}">
                    ...
                    <div class="wsus__cart_text">
                        ...
                        <p>
                            {{$settings->currency_icon}}{{ number_format($sidebarProduct->price, 0, ',', '.') }}
                        </p>
                        <small>Variants total: {{$settings->currency_icon}}{{ number_format($sidebarProduct->options->variants_total, 0, ',', '.') }}</small>
                        <br>
        ...
        <div class="mini_cart_actions {{Cart::content()->count() === 0 ? 'd-none': ''}}">
            <h5>sub total <span id="mini_cart_subtotal">{{$settings->currency_icon}}{{ number_format(getCartTotal(), 0, ',', '.') }}</span></h5>
